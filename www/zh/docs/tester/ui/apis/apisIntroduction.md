...
| **解析引用模型**     | `resolvedRefModels`           | map      | 否       | /        | 解析后的引用模型                                                                                                   |
