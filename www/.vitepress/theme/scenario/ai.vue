...
const loadData = async () => {
  const [error, res] = await http.get(`${PUB_ESS}/content/setting/aiDriven`);
  ...
  <div class="w-full overflow-hidden">
    <div class="mx-auto pt-15">
        <div v-for="(item, index) in features || []" :key="index" class="mb-25">
          ...
          <div class="flex text-3.5 leading-5">
            <template v-if="index % 2 === 0">
              <div class="flex-2/5 min-w-0">
                ...
                <Button :href="item?.learnMore?.url" class="mt-2 bg-gray-menu-bg" style="border-style: none; background: #f7f8fb;">
            ...
            <template v-else>
              ...
              <div class="flex-2/5 min-w-0  ml-15">
                <div
                  v-for="(description, idx) in item.decription"
                  :key="idx"
                  class="max-w-full leading-7"
